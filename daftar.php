...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        ...
        $sql = "INSERT INTO tb_user (nama, username, password, role_id) 
                VALUES ('$nama', '$username', '$password', 2)";
...
<body>
  <div class="login-container">
    ...
    <form action="" method="post">
        ...
        <input type="text" name="nama" class="form-control" id="email" placeholder="Masukkan nama" required>
      </div>
      <div class="mb-3">
